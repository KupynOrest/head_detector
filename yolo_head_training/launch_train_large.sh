...
#SBATCH --exclude=gnodek5,gnodeg3
...
torchrun --nproc_per_node=4 train.py --config-name=yolo_heads_l_large_orest num_gpus=4 multi_gpu=DDP experiment_suffix='yolo_l'
