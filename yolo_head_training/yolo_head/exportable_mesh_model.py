...
__all__ = ["AbstractMeshDecodingModule", "MeshModelExportResult", "ExportableMeshEstimationModel"]


class AbstractMeshDecodingModule(nn.Module):
    """
    ...
    def get_output_names(self) -> List[str]:
        ...
        """
        return ["pre_nms_pred", "pre_nms_raw_pred"]
...
class ExportableMeshEstimationModel:
    """
    ...
    def export(
        ...
        if isinstance(postprocessing, nn.Module):
            ...
            postprocessing_module: AbstractMeshDecodingModule = model.get_decoding_module(**postprocessing_kwargs)
