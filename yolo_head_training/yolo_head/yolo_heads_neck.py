...
class YoloHeadsNeck(BaseDetectionModule):
    """
    ...
    def __init__(
        ...
        neck5: Union[str, HpmStruct, DictConfig],
        neck6: Union[str, HpmStruct, DictConfig],
    ):
        """
        ...
        self.neck5 = factory.get(factory.insert_module_param(neck5, "in_channels", self.neck4.out_channels))
        self.neck6 = factory.get(factory.insert_module_param(neck6, "in_channels", self.neck5.out_channels))

        self._out_channels = [
            self.neck2.out_channels[1],
            self.neck3.out_channels,
            self.neck4.out_channels,
            self.neck5.out_channels,
            self.neck6.out_channels,
        ]
    ...
    def forward(self, inputs: Tuple[Tensor, Tensor, Tensor, Tensor]) -> Tuple[Tensor, ...]:
        c2, c3, c4, c5 = inputs
