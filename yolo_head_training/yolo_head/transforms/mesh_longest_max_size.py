...
@register_transform(name="MeshLongestMaxSize")
class MeshLongestMaxSize(AbstractKeypointTransform):
    """
    ...
    def apply_to_sample(self, sample: MeshEstimationSample) -> MeshEstimationSample:
        if random.random() < self.prob:
            ...
            sample.vertices_2d = self.apply_to_keypoints(sample.vertices_2d, scale)
