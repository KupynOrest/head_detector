...
@register_transform(name="MeshPadIfNeeded")
class MeshPadIfNeeded(AbstractKeypointTransform):
    """
    ...
    def __init__(self, min_height: int, min_width: int, image_pad_value: int, padding_mode: str = "bottom_right"):
        """
    ...
    def apply_to_sample(self, sample: MeshEstimationSample) -> MeshEstimationSample:
        ...
        sample.vertices_2d = self.apply_to_keypoints(sample.vertices_2d, pad_left, pad_top)
